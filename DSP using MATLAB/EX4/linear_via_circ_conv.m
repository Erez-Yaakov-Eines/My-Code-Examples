function [ylin,yDFT] = linear_via_circ_conv(g1,g2)
...
g1p = [g1 zeros(1,length(g2)-1)];% 0 padd to L1+L2-1; length of the linear convolution
g2p = [g2 zeros(1,length(g1)-1)];% 0 padd to L1+L2-1; length of the linear convolution
...
subplot(3,1,1), stem(0:L1+L2-2,ylin);% plot first part convolved series.
...
subplot(3,1,3), stem(0:L1+L2-2,yDFT);% plot results of inverse DFT
