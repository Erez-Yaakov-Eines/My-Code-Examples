function [ylin,yDFT] = linear_via_circ_conv_less_padd_1(g1,g2)
...
g1p = [g1 zeros(1,length(g2)-2)];% 0 padd to L1+L2-2; length of the linear convolution -1
g2p = [g2 zeros(1,length(g1)-2)];% 0 padd to L1+L2-2; length of the linear convolution -1
...
subplot(3,1,1), stem(0:L1+L2-3,ylin);% plot first part convolved series.
...
subplot(3,1,3), stem(0:L1+L2-3,yDFT);% plot results of inverse DFT
